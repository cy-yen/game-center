<template>
  <header class="h-[44px] flex justify-between shrink-0">
    ...
    <div class="flex items-center h-full pr-[15px]">
      <img class="h-[26px] w-[26px] mr-[15px]" src="./../assets/images/wangzhan@2x.png" alt="" @click="showLang" />
      <img
        class="h-[26px] w-[26px]"
...
const menu = ref(null)
const showMenu = () => menu.value.showMenu()

const lang = ref(null)
const showLang = () => lang.value.showLang()
</script>
